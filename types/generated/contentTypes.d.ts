...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Homepage content and hero carousel';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    heroBanners: Schema.Attribute.Component<'shared.hero-banner', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    slug: Schema.Attribute.UID & Schema.Attribute.DefaultTo<'home'>;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Anonymous storefront orders';
    displayName: 'Order';
    pluralName: 'orders';
    singularName: 'order';
  };
  ...
  attributes: {
    amountLeftForFreeDelivery: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
    ...
    deliveryTimeInterval: Schema.Attribute.String;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descriptionItems: Schema.Attribute.Component<
    ...
    unitName: Schema.Attribute.Enumeration<
      ['\u043A\u0433', '\u0448\u0442', '\u0443\u043F\u0430\u043A']
    > &
      Schema.Attribute.DefaultTo<'\u043A\u0433'>;
    unitValue: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site settings, branding, contacts and social links';
